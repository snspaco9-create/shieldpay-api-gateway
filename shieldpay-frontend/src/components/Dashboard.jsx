      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="flex gap-4 mb-6 border-b">
          <button
            ...
            className={`pb-2 px-4 ${activeTab === 'send' ? 'border-b-2 border-blue-600 text-blue-600' : 'text-gray-500'}`}
          >
            Send Money
          </button>
          <button
            onClick={() => setActiveTab('fund')}
            className={`pb-2 px-4 ${activeTab === 'fund' ? 'border-b-2 border-blue-600 text-blue-600' : 'text-gray-500'}`}
          >
            Fund Wallet
          </button>
          <button
